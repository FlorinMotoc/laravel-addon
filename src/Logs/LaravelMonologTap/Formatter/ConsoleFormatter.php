...
namespace FlorinMotoc\LaravelAddon\Logs\LaravelMonologTap\Formatter;
...
class ConsoleFormatter implements FormatterInterface
{
    ...
    private function replacePlaceHolder(\Monolog\LogRecord|array $record): array
    {
        if (!is_array($record) && get_class($record) == \Monolog\LogRecord::class) {
